...
from letskodeitpop.tests.test_sign_up.test_sign_up_negative.sign_up_no_credentials.sign_up_negative import \
    SignUpNegative
...
class TestSuiteRunner(object):
    ...
    def __init__(self):
        ...
        self.test_sign_up_negative_no_credentials = unittest.TestLoader().loadTestsFromTestCase(SignUpNegative)
    ...
    def run_all_tests(self):
        return unittest.TestSuite([self.test_sign_up,
                                   self.test_sign_up_negative_no_credentials,
